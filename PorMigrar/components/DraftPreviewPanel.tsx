...
export function DraftPreviewPanel({ 
  ...
  // Medicamentos de ejemplo para el borrador
  const exampleMedicines = draft.medicines || [
    { name: "Ibuprofeno", dose: "400 mg", frequency: "3 veces al día", duration: "5 días" },
    { name: "Amoxicilina", dose: "500 mg", frequency: "2 veces al día", duration: "7 días" },
    { name: "Omeprazol", dose: "20 mg", frequency: "1 vez al día", duration: "14 días" }
  ].slice(0, draft.medicinesCount);
