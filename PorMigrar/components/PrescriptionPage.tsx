...
import { Plus, Pill, Package, Save, X, FileCheck, AlertTriangle, Clock, ArrowLeft, User, FileText, CheckCircle2, Award, Printer, ShieldAlert, Download, UserPlus } from "lucide-react";
...
export function PrescriptionPage({ draftId, onBack, onNavigateToDrafts, onNavigateToEmitted, patientData }: PrescriptionPageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {/* Header de la receta - Simplificado */}
