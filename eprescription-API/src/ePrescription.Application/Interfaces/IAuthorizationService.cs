...
/// <summary>
/// Medical action types for authorization
/// </summary>
public static class MedicalActions
{
    public const string CreatePrescription = "create_prescription";
    public const string ViewPrescription = "view_prescription";
    ...
    public const string ViewDispensation = "view_dispensation";
    
    public const string ViewPatientRecord = "view_patient_record";
    public const string UpdatePatientRecord = "update_patient_record";
    public const string CreatePatientRecord = "create_patient_record";
