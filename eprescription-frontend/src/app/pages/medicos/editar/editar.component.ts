...
export class EditarMedicoComponent implements OnInit, OnDestroy {
  ...
  onEditDoctor(doctor: Doctor): void {
    // Navigate to a dedicated edit form (could be a separate route)
    this.router.navigate(['/medicos/formulario', doctor.id]);
  }
