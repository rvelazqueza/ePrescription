# Test Task 12.12 - Pharmacies API
# Script automatizado para probar todos los endpoints de Pharmacies

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Task 12.12 - Pharmacies API Tests" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
