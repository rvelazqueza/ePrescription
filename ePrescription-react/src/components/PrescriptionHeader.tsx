...
interface PrescriptionData {
  ...
  bookletNumber?: string; // Número de talonario
  slipNumber?: string; // Número de boleta
}
                ...
                <div className="flex items-center space-x-4 mt-1">
                  ...
                  {prescription.bookletNumber && prescription.slipNumber && (
                    <>
                      ...
                      <p className="text-sm text-gray-600">Talonario: {prescription.bookletNumber}</p>
                      <span className="text-gray-300">•</span>
                      <p className="text-sm text-gray-600">Boleta: {prescription.slipNumber}</p>
                    </>
                  )}
