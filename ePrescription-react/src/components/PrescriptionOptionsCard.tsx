  ...
  return (
    <div className="space-y-4">
      ...
      <Alert className="border-blue-200 bg-blue-50">
        ...
        <AlertDescription>
          <strong className="text-blue-900">Paciente seleccionado:</strong> {patientName}
          <br />
          <span className="text-sm text-blue-700">Elija cómo desea crear la prescripción médica</span>
        </AlertDescription>
      </Alert>
        ...
        <Card className="border-2 hover:border-blue-400 transition-all cursor-pointer group">
          <CardHeader>
            ...
            <CardDescription className="text-sm">
              Crear una receta completamente nueva, agregando medicamentos manualmente
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button 
            ...
            >
              ...
              Comenzar Prescripción
            </Button>
            <ul className="mt-3 text-xs text-muted-foreground space-y-1">
              <li className="flex items-start gap-2">
                <div className="w-1 h-1 rounded-full bg-blue-500 mt-1.5" />
                <span>Tabla vacía de medicamentos</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1 h-1 rounded-full bg-blue-500 mt-1.5" />
                <span>Agregar con doble clic</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1 h-1 rounded-full bg-blue-500 mt-1.5" />
                <span>Alertas de interacciones</span>
              </li>
            </ul>
          </CardContent>
        </Card>
