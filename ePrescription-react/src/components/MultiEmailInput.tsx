/**
 * Componente MultiEmailInput con validación para múltiples correos
 * Permite ingresar múltiples correos electrónicos separados por comas
 */
...
export function MultiEmailInput({
  ...
  useEffect(() => {
    const result = validateMultipleEmails(value);
