...
const menuStructure: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { id: 'ia', label: 'Auditoría Asistente IA', route: '/auditoria/ia', visible: true }
    ]
  },
  {
    id: 'catalogos',
...
export function Sidebar({ currentRoute, onNavigate, collapsed = false, onToggleCollapse }: SidebarProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="p-4 border-b border-blue-800/20 bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-between">
