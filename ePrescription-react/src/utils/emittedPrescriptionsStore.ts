...
export interface Medicine {
  ...
  // NUEVO: Categoría del medicamento para control de talonarios
...
export interface PrescriptionInfo {
  ...
  bookletNumber?: string; // Número del talonario (ej: "TAL-2025-000001")
  slipNumber?: string; // Número de boleta (ej: "0001")
  fullSlipNumber?: string; // Número completo (ej: "TAL-2025-000001-0001")
}
...
// ============================================================================
// DATOS DE PRUEBA - RECETAS EMITIDAS CON MEDICAMENTOS RESTRINGIDOS
// ============================================================================

const initializeMockEmittedPrescriptions = () => {
  
  // RECETA 1: ESTUPEFACIENTE - Tramadol
  EmittedPrescriptionsAPI.savePrescription("RX-2025-001001", {
    prescription: {
      prescriptionNumber: "RX-2025-001001",
      patientName: "Carlos",
      patientFirstLastName: "Ramírez",
      patientSecondLastName: "González",
      patientId: "118540123",
      ...
      diagnosis: "Dolor crónico lumbar",
      clinicalNotes: "Paciente con dolor crónico post-quirúrgico. Prescripción de estupefaciente controlado.",
      doctorName: "Dr. Carlos Alberto Mendoza Herrera",
      doctorLicense: "RM-12345-COL",
      doctorSpecialty: "Medicina del Dolor",
      status: "emitted",
      signatureToken: "SIG-2025-1001",
      qrCode: "QR-RX-2025-001001",
      bookletNumber: "TAL-2025-000003",
      slipNumber: "0001",
      fullSlipNumber: "TAL-2025-000003-0001"
    },
    medicines: [
      {
        id: "med-1001",
        ...
        duration: "7 días",
        route: "Vía oral",
        indications: "Tomar con alimentos. No exceder la dosis prescrita.",
        substitutable: false,
        dispensationStatus: "pending",
        quantityDispensed: 0
      }
    ],
    emittedAt: "2025-11-20T09:15:00Z",
    emittedBy: "Dr. Carlos Alberto Mendoza Herrera",
    dispensationStatus: "emitted",
    origin: "manual"
  });

  console.log("✅ Recetas de prueba con medicamentos restringidos inicializadas");
};

initializeMockEmittedPrescriptions();