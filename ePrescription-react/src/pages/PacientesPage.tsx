...
export function ListaPacientesPage({ onNavigate }: { onNavigate?: (route: string, patientId?: string) => void }) {
    ...
    <div className="space-y-6">
      ...
      <PatientDetailPanel
        ...
        onViewPrescriptions={(id) => {
          if (onNavigate) {
            onNavigate('/pacientes/recetas', id);
          } else {
...
export function RecetasPacientePage({ onNewPrescription, patientId }: RecetasPacientePageProps) {
  ...
  const patient = {
    ...
    insuranceProvider: patientData.insuranceProvider || "Sin seguro",
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <h2 className="text-gray-900">{patient.fullName}</h2>
                  {patientId && (
